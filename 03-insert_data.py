...
try:
    ...
    students = [(None, 'Harry', 'Truman', '1946-1-24', 'htruman@aol.com',
                 '202 South St', 'Vancouver', 'WA', 98660, '792-223-9810',
                 'M', format_date, 'math 101', 'C',  3.50),
                (None, 'Shelly', 'Johnson', '1970-12-12', 'sjohnson@aol.com',
                 '9 Pond Rd', 'Sparks', 'NV', 89431, '792-223-6734', 'F',
                 format_date, 'math 101', 'A', 3.50),
                (None, 'Bobby', 'Briggs', '1967-5-24', 'bbriggs@aol.com',
                 '14 12th St', 'San Diego', 'CA', 92101, '792-223-6178', 'M',
                 format_date, 'math 101', 'B', 3.50),
                (None, 'Donna', 'Hayward', '1970-3-24', 'dhayward@aol.com',
                 '120 16th St', 'Davenport', 'IA', 52801, '792-223-2001', 'F',
                 format_date, 'math 101', 'A', 3.50),
                (None, 'Audrey', 'Horne', '1965-2-1', 'ahorne@aol.com',
                 '342 19th St', 'Detroit', 'MI', 48222, '792-223-2001', 'F',
                 format_date, 'math 101', 'A', 3.50),
                (None, 'James', 'Hurley', '1967-1-2', 'jhurley@aol.com',
                 '2578 Cliff St', 'Queens', 'NY', 11427, '792-223-1890', 'M',
                 format_date, 'math 101', 'A', 3.50),
                (None, 'James', 'Hurley', '1967-1-7', 'jhurley@aol.com',
                 '2578 Cliff St',
                 'Queens', 'NY', 11427, '792-223-1890', 'M', format_date,
                 'math 101', 'A', 3.50),
                (None, 'Lucy', 'Moran', '1951-12-3', 'lmoran@aol.com',
                 '178 Dover St', 'Hollywood', 'CA', 90078, '792-223-9678', 'F',
                 format_date, 'math 101', 'B', 3.50),
                (None, 'Tommy', 'Hill', '1977-11-4', 'thill@aol.com',
                 '672 High Plains', 'Tucson', 'AZ', 85701, '792-223-1115', 'M',
                 format_date, 'math 101', 'A', 3.50),
                (None, 'Andy', 'Brennan', '1960-12-27', 'abrennan@aol.com',
                 '281 4th St', 'Jacksonville', 'NC', 28540, '792-223-8902',
                 'M', format_date, 'math 101', 'A', 3.50)
                ]
